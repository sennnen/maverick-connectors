...
retry, exact cursor acknowledgement, disconnect, and state restore. Eleven embedded artifact tests
replay activation, standard/custom realtime, battery/wrist events, and every admitted historical
record version under Wasm. The v24/v25 bytes are
...
the signed `.mavconn`, verifies its digest, and runs all embedded fixtures.
